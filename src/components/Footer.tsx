  ...
  return (
    <footer className="bg-zinc-950 text-zinc-400 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+5554334286811" className="hover:text-orange-400 transition-colors">
                (54) 3342-8681
              </a>
            </li>
            <li className="flex items-start gap-2">
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white font-bold text-sm px-5 py-3 rounded-full transition-all"
          >
      ...
      <div className="border-t border-zinc-800 py-5 text-center text-xs text-zinc-600">
        © {new Date().getFullYear()} Exclusive Multimarcas — Marau, RS. Todos os direitos reservados.
      </div>
    </footer>
  );
}
